...
Guard 0.18.0, prepared for 2026-09-08, is the first package release under
Apache-2.0. Publication is pending. Prior tagged and PyPI releases are not
retroactively relicensed or replaced. Issue #30 remains open until the release
is merged and PyPI/external-install verification succeeds.
