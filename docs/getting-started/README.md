...
| Waveframe Cloud | Not declared | Not declared for hosted v3 delivery | Existing v1/v2 and finance integration behavior | Guard accepts matching v2/v3 atomic publication envelopes. Current hosted Cloud is not claimed to serve v3; hosted v3 delivery requires a separately reviewed Cloud change. |
