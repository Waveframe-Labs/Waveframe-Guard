...
def test_registry_claim_contract_across_distributions(tmp_path, surface, document, paragraph, rejected):
    ...
    def inspect():
        if surface == "source":
            ...
            prefix = "waveframe_guard-0.19.0.data/data/share/doc/waveframe-guard/" if surface == "wheel" else ""
            ...
            if surface == "wheel":
                ...
                package_acceptance._inspect_wheel(path, "0.19.0")
            else:
                ...
                package_acceptance._inspect_sdist(path, "0.19.0")
    if rejected:
